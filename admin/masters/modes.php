...
require_permission('education_modes.view');
...
$total_count = (int)$pdo->query("SELECT COUNT(*) FROM education_modes")->fetchColumn();
  ...
  <main class="main">
    ...
    <div class="content">
      ...
      <div class="page-header">
        <div>
          <h3>Education Modes</h3>
          <p>Manage available education modes for universities</p>
        </div>
      </div>
      <?php 
            ...
            <div class="form-card">
              <form method="POST">
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                  ...
                  <input type="text" name="name" class="form-control" placeholder="e.g. Distance & Online"
            ...
            <div class="form-card" style="border-color:var(--accent);">
              <form method="POST">
                ...
                <div style="display:flex;gap:.75rem;">
                  <a href="<?= ADMIN_URL ?>/masters/modes.php" class="btn btn-secondary"
          ...
          <div class="panel">
            <table>
              ...
              <tbody>
                <?php if ($all):
                  foreach ($all as $i => $m): ?>
                    <tr data-ba-row-id="<?= $m['id'] ?>" data-ba-module="education_modes" class="<?= ($edit_item && $edit_item['id'] == $m['id']) ? 'edit-row' : '' ?>">
                      <?php if (has_team_action('Delete')): ?>
                      ...
                      <td>
                        <div class="ba-trigger-cell">
                          ...
                          <button type="button" class="btn btn-secondary btn-sm ba-manage-btn"
                            onclick="openBulkModal('education_modes', <?= $m['id'] ?>, <?= htmlspecialchars(json_encode($m['mode_name']), ENT_QUOTES) ?>)"
