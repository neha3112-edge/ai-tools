...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (empty($errors) && !empty($_FILES['image']['name'])) {
    ...
    if (!$image)
      $errors['image'] = 'Invalid image. Use JPG/PNG/WEBP under 2MB.';
  }
  ...
  if (empty($errors) && !empty($_FILES['sample_certificate']['name'])) {
    ...
    if (!$cert)
      $errors['sample_certificate'] = 'Invalid file. Use JPG/PNG under 2MB.';
  }
        ...
        <div class="form-card" style="margin-bottom:1.25rem;">
          <div class="form-grid">
            <div class="form-group">
              ...
              <input id="uni_name" name="name" type="text" class="form-control" placeholder="e.g. Amity University"
            ...
            <div class="form-group">
              <label>Slug</label>
              <input id="uni_slug" name="slug" type="text" class="form-control" placeholder="auto-generated from name"
                value="<?= e($old['slug'] ?? '') ?>">
              <span class="form-hint">Preview: <code id="uni_slug_preview"
                  style="color:var(--accent);"><?= e($old['slug'] ?? '—') ?></code></span>
            ...
            <div class="form-group">
              ...
              <input name="campus_location" type="text" class="form-control" placeholder="e.g. Noida, Uttar Pradesh"
        ...
        <div class="form-card" style="margin-bottom:1.25rem;">
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <input name="nirf_ranking" type="number" min="1" class="form-control" placeholder="e.g. 45"
                value="<?= e($old['nirf_ranking'] ?? '') ?>">
            </div>
            <div class="form-group">
              <label>Avg. Placement Package</label>
              <input name="avg_placement_package" type="text" class="form-control" placeholder="e.g. 12 LPA"
                value="<?= e($old['avg_placement_package'] ?? '') ?>">
            </div>
            <div class="form-group">
              <label>View University Link</label>
              <input name="view_university_link" type="url" class="form-control" placeholder="https://..."
