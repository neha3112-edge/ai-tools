        ...
        <tbody>
          <?php if ($universities): ?>
            ...
            <tr>
              ...
              <td><?= $u['university_type'] ? '<span class="badge" style="background:rgba(79,110,247,0.1);color:var(--accent-h);">'.e($u['university_type']).'</span>' : '—' ?></td>
            ...
            <tr>
              <td colspan="8">
                <div class="empty-state">
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M3 21h18M5 21V7l7-4 7 4v14M9 21V11h6v10"/></svg>
