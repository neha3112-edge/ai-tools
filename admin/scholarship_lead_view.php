...
try {
  $stmt = $pdo->prepare("SELECT * FROM scholarship_leads WHERE id = ?");
  $stmt->execute([$id]);
  $lead = $stmt->fetch(PDO::FETCH_ASSOC);

  if (!$lead) {
    set_flash('error', 'Scholarship Lead not found.');
    redirect(ADMIN_URL . '/scholarship_leads.php');
  }
...
$page_title = 'View Scholarship Lead';
...
<head>
  ...
  <title>View Scholarship Lead — SODE AI Tools</title>
    ...
    <div class="content">
      <div class="page-header" style="margin-bottom: 1.5rem;">
        ...
        <div class="page-actions">
          <a href="scholarship_leads.php" class="btn btn-secondary">
