...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name && !is_slug_unique($pdo, 'courses', $final_slug, $id)) {
    ...
    if (empty($errors)) {
        try {
            ...
            set_flash('success', "Course '{$name}' updated successfully.");
            redirect(ADMIN_URL . '/courses/index.php');
        } catch (Exception $e) {
...
<title>Edit Course — SODE AI Tools</title>
...
<main class="main">
  ...
  <div class="content">
    ...
    <div class="page-header">
      <div><h3>Edit: <?= e($course['name']) ?></h3><p>ID #<?= $id ?></p></div>
