...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors) && !empty($_FILES['brochure_file']['name'])) {
        ...
        if (!$brochure) $errors['brochure_file'] = 'Invalid brochure file. Must be a PDF, JPG, PNG or WEBP under 10MB.';
    }
...
<main class="main">
  ...
  <div class="content">
    ...
    <div class="page-header">
      <div><h3>New Mapping</h3><p>Fields marked <span style="color:var(--danger)">*</span> are required</p></div>
        ...
        <div class="form-grid">
          <div class="form-group">
            ...
            <input name="academic_fees" type="number" step="0.01" class="form-control"
                   placeholder="e.g. 50000" value="<?= e($old['academic_fees'] ?? '') ?>">
          ...
          <div class="form-group">
            ...
            <input name="fees_discount" type="number" step="1" class="form-control"
                   placeholder="e.g. 5000" value="<?= e($old['fees_discount'] ?? '') ?>">
          ...
          <div class="form-group full">
            ...
            <span class="form-hint">Max size: 10MB. Allowed: PDF, JPG, PNG, WEBP</span>
